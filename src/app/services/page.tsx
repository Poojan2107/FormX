            ...
            {services.map((service, i) => (
              <Reveal key={service.slug} delay={0.03 * (i % 3)}>
                <Link
                  ...
                  className="x-border group flex h-full flex-col border border-line p-7 transition-all hover:border-transparent hover:shadow-[0_12px_40px_rgba(0,0,0,0.06)] md:p-8"
                >

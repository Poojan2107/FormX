            ...
            {blogs.map((post, i) => (
              <Reveal key={post.slug} delay={0.03 * (i % 3)}>
                <Link
                  ...
                  className="x-desat formx-cut-x formx-edge formx-edge-x x-hover-rail group flex h-full flex-col border border-line bg-white transition-all hover:border-x-red/35 hover:shadow-[0_16px_40px_rgba(222,48,36,0.06)]"
                >
                  <AssetImage
                    alt={post.title}
                    slot={post.asset}

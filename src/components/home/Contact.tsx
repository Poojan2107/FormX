      ...
      <Container>
        <div className="grid overflow-hidden border border-line lg:grid-cols-2">
          <Reveal className="bg-black p-8 text-white md:p-12">
            ...
            <h2 className="mt-8 font-display text-3xl font-bold uppercase tracking-tight md:text-[2.15rem]">
            ...
            {sent ? (
              <div className="mt-10 border border-line bg-white p-6">
                ...
                <p className="mt-2 text-sm text-ink-muted">
                  Your enquiry has been received. Our team will connect shortly.
                </p>
                <Button
                  type="button"
                  variant="outline"

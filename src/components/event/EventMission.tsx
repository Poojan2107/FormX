    ...
    <section id="mission" className="scroll-mt-[5.75rem] bg-white overflow-hidden">
      ...
      <div className="mx-auto w-full max-w-[1760px] px-5 sm:px-8 md:px-12 lg:px-16 py-16 md:py-24">
        <div className="grid items-stretch gap-8 lg:grid-cols-12 lg:gap-12 w-full">
          ...
          >
            <div className="relative w-full border-l-4 border-x-red bg-[#f7f6f2] p-8 sm:p-10 md:p-14 lg:p-16 shadow-xs border-y border-r border-ink/15">
              {/* Corner CAD Ticks */}
              ...
              <p className="font-display text-[clamp(1.2rem,2vw,1.65rem)] font-bold leading-[1.6] text-ink">
                {eventMission.p1}
              </p>

              <div className="my-6 sm:my-8 h-px w-full bg-ink/10" aria-hidden />

              <p className="font-display text-[15.5px] leading-[1.8] text-ink/80 md:text-[18px]">
          ...
          {eventMission.values.map((value, i) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="font-display text-[clamp(1.3rem,2.2vw,1.75rem)] font-black uppercase leading-[1.05] tracking-[0.05em]">

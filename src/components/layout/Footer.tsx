  ...
  return (
    ...
    >
      ...
      <Container className="relative z-10">
        {/* Full site only — removed in event mode (Navigate / Quick Actions block) */}
        {!eventMode ? (
                ...
                {quickActions.map((a) =>
                  a.external ? (
                    <a
                      ...
                      className="formx-cut-sm group flex w-full items-center justify-between border border-white/15 bg-white/[0.02] px-5 py-4 transition-all hover:border-x-red/80 hover:bg-x-red/[0.05]"
                    >
        ...
        <div
          className={`relative overflow-hidden text-center md:text-left ${
            eventMode ? "pb-6 pt-14 md:pt-16" : "border-t border-white/10 pb-6 pt-12"
          }`}
        >
          <div className="flex flex-col items-center justify-center md:items-start">
            <div className="relative w-full select-none font-display font-black uppercase leading-none">
              ...
              >
                FORM
                <span className="inline-block text-x-red drop-shadow-[0_0_40px_rgba(224,49,40,0.35)]">
                  ×
                </span>
              </span>
            </div>

            <div className="mt-6 flex w-full flex-wrap items-center gap-3 border-t border-white/10 pt-4">
      ...
      <div className="border-t border-white/[0.08] bg-black/60 py-4.5">
        <Container className="flex flex-col gap-3 font-label text-[12px] text-white/40 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-x-6 gap-y-2">
            ...
            {eventMode ? (
              <a href="#contact" className="transition-colors hover:text-x-red">
                Contact
              </a>
            ) : (
              <Link

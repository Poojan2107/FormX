...
export const formxMethod = {
  ...
  code: "FORM× · BI",
  belief:
    "A drawing that leaves too early becomes someone else's problem on site. We hold Architecture, Structure and Infrastructure in one room until the facility is ready to be built — then we issue.",
  promise:
    "The sheets that leave this studio already know how the facility will stand, expand and operate.",
  stamp: "When we issue, we mean it.",
  ...
  stages: [
    {
      ...
      num: "01",
      title: "Read",
      verb: "Understand the land and the work",
      decision: "What does this plot allow — and what will it resist?",
      why: "Levels, access, soil and operations shape foundations and docks long before any elevation is drawn for presentation.",
      prevents: "Flooded pads, docks that miss the road, and beautiful plans that cannot be built.",
      disciplines: "Infrastructure · Architecture · Structure",
      slot: "projects/pdf_p4_1.jpeg",
      caption: "The site speaks first",
    },
    {
      id: "lock",
      num: "02",
      title: "Lock",
      verb: "Make the disciplines agree",
      decision: "Are Architecture, Structure and Infrastructure describing the same facility?",
      why: "Grids, clear heights, expansion bays and site routes must settle together. Coordination after GFC is already a cost.",
      prevents: "Rework after tender, utility clashes, and expansion the frame cannot carry.",
      disciplines: "Architecture · Structure · Infrastructure",
      slot: "projects/brochure/brochure_p1_1.png",
      caption: "One facility. One truth.",
    },
    {
      id: "carry",
      num: "03",
      title: "Carry",
      verb: "Trace every force to the ground",
      decision: "How do cranes, machines, wind and seismic loads travel safely?",
      why: "Structure is sized for real industrial forces and detailed so steel and cages go up without improvisation.",
      prevents: "Ambiguous connections, PEB/RCC surprises, and value engineering that cuts safety.",
      disciplines: "Structure",
      slot: "projects/brochure/brochure_p7_1.png",
      caption: "Load paths, made visible",
    },
    {
      id: "issue",
      num: "04",
      title: "Issue",
      verb: "Release only what can be built",
      decision: "What must be closed before a sheet leaves the studio?",
    ...
    },
    {
      ...
      num: "05",
      title: "Stand",
      verb: "Stay with the work until it stands",
      decision: "Does the built facility still match what was locked?",
      why: "Quantities, clarifications and coordination continue until the plant matches intent — engineers who signed the sheets stay close.",
      prevents: "Silence between drawing issue and a facility people can occupy.",
      disciplines: "Practice · Site support",
      slot: "projects/brochure/brochure_p3_2.png",
      caption: "Built work is the proof",
    },
  ],
} as const;

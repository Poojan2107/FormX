...
with open(r'd:\FormX\FormX-master\.planning\ocr_runner.ps1', 'w', encoding='utf-8') as f:
    f.write(ps_code)

res = subprocess.check_output(['powershell', '-ExecutionPolicy', 'Bypass', '-File', r'd:\FormX\FormX-master\.planning\ocr_runner.ps1'], text=True)
print(res)
